...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'sell', redirectTo: 'account/listings/new', pathMatch: 'full' },
      ...
      { path: 'account/listings', canActivate: [authGuard], loadComponent: () => import('./features/listings/listing-management.component').then(m => m.ListingManagementComponent) },
