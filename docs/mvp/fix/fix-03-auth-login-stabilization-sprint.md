...
- Verification baseline recorded in
  `docs/mvp/fix/auth-stab-p0-01-auth-verification-baseline.md`.
...
- `docs/mvp/iam/signup-05-google-identity-provider-wiring.md`
...
- `docs/mvp/iam/signup-04-backend-credential-registration-bridge.md`
- `docs/mvp/iam/signup-05-google-identity-provider-wiring.md`
...
```powershell
rg -n "Google|enable|hidden|feature flag" docs/mvp/iam/signup-05-google-identity-provider-wiring.md
```
