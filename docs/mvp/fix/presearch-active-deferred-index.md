...
or deferred V2 code before search work starts.
...
- `product-service`: categories, listing drafts, listing media, seller listing
  lifecycle, public listing browse/detail, business store browse input, and
  listing moderation.
...
Upcoming search slices should build on:
...
- Future OpenSearch projector/index work only when the roadmap slice calls for
  it
...
- `docs/mvp/search/search-02b-business-storefront-keyword-search.md`
- `docs/mvp/search/search-03-cursor-pagination-and-filters.md`
